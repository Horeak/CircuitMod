...
public class DataDecryptionPacket extends AbstractPacket{

    int x, y, z;
    String value;

    public DataDecryptionPacket(){}
    public DataDecryptionPacket(TileEntity tile, String text){
        x = tile.xCoord;
        y = tile.yCoord;
        z = tile.zCoord;
    ...
    public void onMessage(Side side, EntityPlayer player) {
        ...
        if(world.getTileEntity(x,y,z) instanceof TileEntityDataDecryptor){
            ...
            if(side == Side.SERVER){
                PacketHandler.sendToAll(new DataDecryptionPacket(tile, value), CircuitMod.Utils.channels);
            }
