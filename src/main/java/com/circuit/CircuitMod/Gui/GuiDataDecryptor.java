...
public class GuiDataDecryptor extends GuiScreen
{
    ...
    public GuiDataDecryptor(TileEntityDataDecryptor tile){
        this.tile = tile;
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(1, posX + 20, posY + 55, 120, 20, StatCollector.translateToLocal("gui.decryption.save")));
    ...
    protected void actionPerformed(GuiButton bt) {
        ...
        if (id == 1){
            PacketHandler.sendToServer(new DataDecryptionPacket(tile, TextSave), CircuitMod.Utils.channels);
