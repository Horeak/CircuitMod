...
import com.circuit.CircuitMod.TileEntity.DataBlocks.TileEntityDataDetector;
...
public class ModBlockDataDetector extends ModBlockContainer {

    IIcon front, Side;


    public ModBlockDataDetector() {
        super(Material.iron);
    }

    @Override
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileEntityDataDetector();
    }

    @SideOnly(cpw.mods.fml.relauncher.Side.CLIENT)
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        front = par1IconRegister.registerIcon(Ref.ModId + ":" + "DataDetectorFront");
