...
public class ModBlockDataEncryptor extends ModBlockContainer {
    ...
    public ModBlockDataEncryptor() {
        super(Material.iron);
    }

    @Override
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileEntityDataEncryptor();
    }

    @SideOnly(cpw.mods.fml.relauncher.Side.CLIENT)
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        front = par1IconRegister.registerIcon(Ref.ModId + ":" + "DataEncryptorFront");
