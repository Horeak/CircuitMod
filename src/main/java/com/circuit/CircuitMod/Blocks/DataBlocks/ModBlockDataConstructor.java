...
public class ModBlockDataConstructor extends ModBlockContainer {

    public ModBlockDataConstructor() {
        super(Material.iron);
    }

    @Override
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileEntityDataConstructor();
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.IconFront = par1IconRegister.registerIcon(Ref.ModId + ":" + "DataConstructorFront");
