...
public class TileEntityMultiDigitCounterRender extends TileEntityBlockInfoRender {
    ...
    public static Color Def = new Color(71, 0, 16);
    public static Color Bord = new Color(75, 12, 2);

    public TileEntityMultiDigitCounterRender() {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale, int f) {
        ...
        if (te instanceof TileEntityMultiDigitCounter) {
            TileEntityMultiDigitCounter tile = (TileEntityMultiDigitCounter) te;
