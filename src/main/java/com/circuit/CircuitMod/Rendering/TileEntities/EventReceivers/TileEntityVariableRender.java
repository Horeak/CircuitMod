...
public class TileEntityVariableRender extends TileEntityBlockInfoRender {
    ...
    public static Color Def = new Color(76, 76, 106);
    public static Color Bord = new Color(126, 126, 126);

    public TileEntityVariableRender() {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale, int f) {
        ...
        if (te instanceof TileEntityVariable) {
            TileEntityVariable tile = (TileEntityVariable) te;
