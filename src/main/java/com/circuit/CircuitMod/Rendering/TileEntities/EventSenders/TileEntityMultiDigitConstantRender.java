...
public class TileEntityMultiDigitConstantRender extends TileEntityBlockInfoRender {
    ...
    public static Color Bord = new Color(0, 0, 0);

    public TileEntityMultiDigitConstantRender() {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        if (te instanceof TileEntityMultiDigitConstant) {
            TileEntityMultiDigitConstant tile = (TileEntityMultiDigitConstant) te;
