...
public class DefaultCircuitBlockModel extends ModelBase
{
    //fields
    ...
    public DefaultCircuitBlockModel()
    {
        textureWidth = 128;
        textureHeight = 32;
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, Color Default, Color Border)
    {
        ...
        GL11.glColor4f(Default.getRed() / (float)255, Default.getGreen() / (float)255, Default.getBlue() / (float)255, 1F);
        Shape13.render(f5);
